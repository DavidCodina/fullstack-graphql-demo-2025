...
const defaultValue = options[0] as MaybeOption

/* ========================================================================
                      UncontrolledReactSelectDemo
======================================================================== */

export const UnontrolledReactSelectDemo = () => {
  ...
  // setter is used.
  const [selectValue, setSelectValue] = useState<MaybeOption>(defaultValue)
